...
public class TogetherWS {
	 ...
	 */
	@OnOpen //如同servlet init, 雙方連線初次建立時執行
	...
	@OnMessage //如同超 Servlet service方法, 有請求(接到訊息)就會執行
	public void onMessage(Session userSession, String message) {
		for (Session session : connectedSessions) { // 群聊，通通送message
			if (session.isOpen())
	...
	@OnClose //如同servlet destroy, 連線結束時會執行。
